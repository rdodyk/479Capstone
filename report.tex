...
For our preliminary design, our task was to outline our proposed loads, structural systems, connection concepts, materials, innovations and justification of our design. We also presented plan and elevation views of the proposed structure. 

We compared and contrasted materials of steel, concrete and timber shown in Table \ref{tab:matCompare} below. \\

\begin{table}[h!]
    \centering
    \caption{Material Comparison}
    \label{tab:matCompare}
    \begin{tabular}{p{4.5cm} p{4.5cm} p{4.5cm}}
        \toprule
        \multicolumn{1}{c}{\textbf{Steel}} & \multicolumn{1}{c}{\textbf{Concrete}} &  \multicolumn{1}{c}{\textbf{Timber}}\\
        \midrule
        \multicolumn{3}{c}{\textbf{Pros}} \\ 
\hline
	\small{Highest strength to weight ratio} & \small{Long spans} & \small{Highest strength to density ratio} \\ \hline
	\small{Accelerates construction} & \small{Soil compatibility} & \small{Aesthetic} \\ \hline
	\small{Effective performance in seismic events} & \small{Vibration and deflection control} & \small{BC timber industry} \\ \hline
	\multicolumn{3}{c}{\textbf{Cons}}  \\ 
\hline
	\small{Corrodes over time} & \small{Heavy} & \small{Large member sizes} \\ \hline
	 & \small{Increased demand on lateral system} & \small{Time and environmentally dependent material properties}\\ \hline
	 & & \small{Timber hybrid system connection complexity} \\
        \bottomrule
    \end{tabular}
\end{table}

Corrugated steel decks were chosen due to fast constructability and easy formwork. Our penthouse roof features corrugated steel with concrete in order to prevent vibration as it will be occupied by the mechanical room. While the main roof will feature a corrugated steel deck as it will not require as much occupancy. Open web steel joists (OWSJ) were chosen due to the longer spans of our layout and also for economically purposes as they are less expensive than beams. \\

For our gravity system we designed for:
\begin{itemize}
\item Steel-concrete composite deck supported by OWSJs
\item Steel W-section beams supporting joists and penthouse columns
\item HSS columns to decrease weight
\item Pad footing foundation
\end{itemize}

OWSJs make routing services around the building easier and are more efficient than W-shape beams. The choice of HSS columns can potentially make the building about 13000 kg lighter than other various shapes. For our pad foundation, we decided to design footings because based on our geotechnical report and our loads, we found that the use of spread footings will be cheaper than piles. \\

For our lateral system we designed for:
\begin{itemize}
\item Three concentrically braced frames and shear wall stair core
\item Moment resisting system in the penthouse to simplify seismic analysis
\item Using a less ductile system to simplify connection and foundation design
\end{itemize}
...
%While this comes at the expense of some structural efficiency, the savings in construction planning will make up for the loss. 
